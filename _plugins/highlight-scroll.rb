module Jekyll
  module Tags
    class HighlightScrollBlock < Liquid::Block
  ...
  <div>
    <pre><code class='#{@lang.to_s.gsub("+", "-")}'>#{h(code).strip}</code></pre>
      ...
      def add_code_tags(code, lang)
        ...
        code = code.sub(/<pre>\n*/,'<pre class="pre-scrollable"><code class="' + lang.to_s.gsub("+", "-") + '">')
        code = code.sub(/\n*<\/pre>/,"</code></pre>")
        code.strip
      end
...
Liquid::Template.register_tag('highlightscroll', Jekyll::Tags::HighlightScrollBlock)
